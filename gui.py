...
record_button=Button(btn_frame,image=img,command=chk,bg='#282923', highlightthickness = 0, bd = 0)
...
stop_button=Button(btn_frame,image=img2,bg='#282923', highlightthickness = 0, bd = 0)
